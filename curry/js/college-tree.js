...
var tree = d3.layout.tree()
    .size([college_tree_height, college_tree_width]);

var diagonal = d3.svg.diagonal()
    .projection(function(d) { return [d.y, d.x]; });

var college_tree_svg = d3.select("#college-tree").append("svg")
    .attr("width", college_tree_width + college_tree_margin.right + college_tree_margin.left)
    .attr("height", college_tree_height + college_tree_margin.top + college_tree_margin.bottom)
    .append("g")
...
function update(source) {
    ...
    // Update the nodes…
    var node = college_tree_svg.selectAll("g.node")
    ...
    // Update the links…
    var link = college_tree_svg.selectAll("path.link")
